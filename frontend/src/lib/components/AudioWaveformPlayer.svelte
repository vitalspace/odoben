...
<div class="audio-player-container bg-gradient-to-br from-odoben-surface/80 to-odoben-bg/80 backdrop-blur-xl border border-odoben-primary/20 rounded-2xl p-6 shadow-2xl">
	<!-- Header -->
	<div class="flex items-center gap-4 mb-6">
		<div class="w-16 h-16 bg-gradient-to-br from-odoben-primary to-odoben-aqua rounded-xl flex items-center justify-center text-3xl shadow-lg">
			🎵
		</div>
	...
	<div class="h-24 bg-odoben-bg/30 rounded-xl border border-odoben-primary/10 mb-6 overflow-hidden">
		<canvas
			bind:this={canvas}
			width="600"
			height="96"
